...
export default function Post (props) {
  ...
  const inlineHtmlAttachmentPreviewSlugs = BLOG.inlineHtmlAttachmentPreviewSlugs || []
  const enableInlineHtmlAttachmentPreview = inlineHtmlAttachmentPreviewSlugs.includes(post.slug)
